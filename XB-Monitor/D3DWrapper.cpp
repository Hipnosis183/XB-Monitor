...
#pragma comment(lib, "../Shared/d3d9.lib")
#pragma comment(lib, "../Shared/d3dx9.lib")
...
HRESULT HookIDirect3D9::CreateDevice(LPVOID _this, UINT Adapter,
