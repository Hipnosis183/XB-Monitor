...
namespace XBMonitor.Classes
{
    class XBConfig
    {
        // Initialize configuration files.
        public static byte[] MonitorInputLoad = new byte[0x70];
        public static byte[] MonitorOptLoad = new byte[0x0C];

        public const string MonitorInputFile = "monitor_input.bin";
        public const string MonitorOptFile = "monitor_opt.bin";
        ...
        public static void InitialSetup()
        {
            ...
            if (File.Exists(MonitorOptFile))
            {
                MonitorOptLoad = File.ReadAllBytes(MonitorOptFile);
            }
        }

        // Write configuration files.
        public static void WriteXBConfig()
        {
            WriteXBFile(MonitorInputFile, MonitorInputLoad, 0x00, 0x70);
            WriteXBFile(MonitorOptFile, MonitorOptLoad, 0x00, 0x0C);
        }

        public static void WriteXBFile(string FileNameInput, byte[] FileNameOutput, int Offset, int Lenght)
        {
        ...
        {
            Check.Checked = MonitorOptLoad[HexPosition] == 0x01;
        }

        public static void SetConfig_CheckBox(CheckBox Check, int HexPosition)
        {
            MonitorOptLoad[HexPosition] = Check.Checked ? (byte)0x01 : (byte)0x00;
        }
